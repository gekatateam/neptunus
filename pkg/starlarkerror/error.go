...
func (e Error) Hash() (uint32, error) {
	return 0, errors.New("error.error is not hashable")
}

func New(_ *starlark.Thread, b *starlark.Builtin, args starlark.Tuple, kwargs []starlark.Tuple) (starlark.Value, error) {
	var msg string
